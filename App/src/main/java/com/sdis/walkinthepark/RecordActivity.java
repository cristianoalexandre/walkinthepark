...
import com.sdis.walkinthepark.types.NavPoint;
...
public class RecordActivity extends Activity {
            ...
            public void onLocationChanged(Location location) {
                ...
                if (lastLocation != null) {
                    if (recording && location.getAccuracy() < MINIMUM_ACCEPTABLE_ACCURACY) {
                        distanceElapsed += location.distanceTo(lastLocation);
                        navpoints.add(new NavPoint(location));
                        System.out.println("=================");
                        System.out.println(navpoints.get(navpoints.size() - 1));
                        System.out.println("Distance elapsed: " + location.distanceTo(lastLocation));
    ...
    public void showDistanceElapsed() {
        ...
        distanceElapsedView.setText(String.format("%.1f", distanceElapsed / 10000) + " km");
    }
